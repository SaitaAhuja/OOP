...
class ConstructionTruck: public HeavyVehicle{
	...
	public:
		...
		,double mw,int w,double l,string c):Vehicle(t,mk,mdl,clr,y,miles), HeavyVehicle(t,mk,mdl,clr,y,miles,tank,energy
		,mw,w,l),cargo(c) {}
		string getcargo(){
			return cargo;
		}
...
class Bus:public HeavyVehicle{
	...
	public:
        ...
        cout<<"\nGas Vehicle Class Members"<<endl;
        cout<<"Tank Size:"<<getfueltanksize()<<endl;
        
        cout<<"\nElectric Vehicle Class Members"<<endl;
        cout<<"Energy Storage:"<<getenergystorage()<<endl;
        
        cout<<"\nHeavy Vehicle Class Members"<<endl;
